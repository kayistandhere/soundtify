  ...
  <div class="bg-module">
    ...
    <section>
      <div class="col-12 p-2 text-white">
        <div class="">
          <div @click="profileSocial">
            <img :src="this.indexUser.avatar" class="rounded custom-objectfit-cover" alt="avatar-user" height="50"
              width="50" />
            ...
            <div class="modal-dialog modal-xl">
              <div class="modal-content bg-module">
                <div class="modal-header border-0">
                  <h5 class="modal-title" id="staticBackdropLabel text-center">
                    POST SHORT SONG
                  </h5>
    ...
    <!-- REACTION POST -->
    <section :key="sentiment.id" v-for="sentiment in sentimentAll">
      <sentiment-list-item :sentiment="sentiment"></sentiment-list-item>
    </section>
  </div>
</template>
...
import sentimentListItem from '@/components/sentiment_list_items/sentiment_list_item.vue';
export default {
  components: {
    navbarFirst,
    buttonMdRadius,
  ...
  methods: {
    ...
    handleUpperInput() {
      ...
      if (
        this.upperValue <
        parseInt(this.lowerValue) + parseInt(this.sliderSpace)
      ) {
    ...
    handleLowerInput() {
      ...
      if (
        this.lowerValue >
        parseInt(this.upperValue) - parseInt(this.sliderSpace)
      ) {
        this.upperValue =
          parseInt(this.lowerValue) + parseInt(this.sliderSpace);
      }
    ...
    async handleChange() {
      ...
      if (getFile.length !== 0) {
        ...
        const storageRef = ref(
          firebase.storage,
          `Sentiment/${firebase.auth.currentUser.uid}/` + fileImage.name
        );
